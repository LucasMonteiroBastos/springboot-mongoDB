...
public class Instantiation implements CommandLineRunner {
	...
	// injetando o user Repository no banco de dados
	@Autowired
	private UserRepository userRepository;

	// injetando o postRepository no banco de dados
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		// limpando as colecoes no banco de dados
		...
		// instanciando os post & associando com o author/user
